...
- The test has some flows, because it can also return positive result when given to a human. Luckilly, the chance of such a result is small, 10%, i.e. given that you test a human in 10 out of 100 cases it will return positive result.
